...
### API <a name="api"></a>
- Tha app consumes this [API](https://github.com/stephenkati/hello-rails-backend)
...
```
  ...
  git clone https://github.com/stephenkati/hello-rails-front-end.git
```
...
Feel free to check the [issues page](https://github.com/stephenkati/hello-rails-front-end/issues).
